...
var BrowserDomAdapter = class _BrowserDomAdapter extends GenericBrowserDomAdapter {
  ...
  onAndCancel(el, evt, listener3) {
    el.addEventListener(evt, listener3);
    return () => {
      el.removeEventListener(evt, listener3);
    };
  }
...
function provideClientHydration(...features) {
  ...
  for (const {
    ...
    if (\u0275providers.length) {
      providers2.push(\u0275providers);
    }
  }
  if (typeof ngDevMode !== "undefined" && ngDevMode && featuresKind.has(HydrationFeatureKind.NoHttpTransferCache) && hasHttpTransferCacheOptions) {
    throw new Error("Configuration error: found both withHttpTransferCacheOptions() and withNoHttpTransferCache() in the same call to provideClientHydration(), which is a contradiction.");
  }
  return makeEnvironmentProviders([typeof ngDevMode !== "undefined" && ngDevMode ? provideZoneJsCompatibilityDetector() : [], withDomHydration(), featuresKind.has(HydrationFeatureKind.NoHttpTransferCache) || hasHttpTransferCacheOptions ? [] : withHttpTransferCache({}), providers2]);
}
...
var _HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  registerNonRouterCurrentEntryChangeListener(listener3) {
    return this.location.subscribe((event) => {
      if (event["type"] === "popstate") {
        listener3(event["url"], event.state);
      }
    });
  }
...
var _c0 = (a0) => ({ itemsPerPage: 2, currentPage: a0 });
...
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 6, consts: [[4, "ngFor", "ngForOf"], [3, "pageChange"]], template: function HomeComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind2(4, 1, ctx.collection, \u0275\u0275pureFunction1(4, _c0, ctx.p)));
  }
...
var routes = [
  { path: "register", component: RegisterComponent },
  {
    ...
    loadChildren: () => import("./chunk-RJALQCLM.js").then((m) => m.SharedModule)
  },
  {
    path: "product",
...
var AnimationAstBuilderVisitor = class {
  ...
  visitKeyframes(metadata, context) {
    ...
    const keyframes = metadata.steps.map((styles2) => {
      const style2 = this._makeStyleAst(styles2, context);
...
var TimelineBuilder = class _TimelineBuilder {
  ...
  setStyles(input, easing, errors, options) {
    ...
    const styles2 = flattenStyles(input, this._globalTimelineStyles);
    for (let [prop, value] of styles2) {
...
var AnimationTransitionNamespace = class {
  ...
  prepareLeaveAnimationListeners(element) {
    ...
    if (listeners && elementStates) {
      ...
      listeners.forEach((listener3) => {
        const triggerName = listener3.name;
  ...
  drainQueuedTransitions(microtaskId) {
    ...
    this._queue.forEach((entry) => {
      ...
      if (listeners) {
        listeners.forEach((listener3) => {
          if (listener3.name == entry.triggerName) {
            const baseEvent = makeAnimationEvent(element, entry.triggerName, entry.fromState.value, entry.toState.value);
            baseEvent["_data"] = microtaskId;
            listenOnPlayer(entry.player, listener3.phase, baseEvent, listener3.callback);
          }
        });
      }
...
@angular/platform-browser/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=main-FGIYGJU3.js.map
