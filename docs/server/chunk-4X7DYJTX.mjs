...
import {
  ...
  transition,
  trigger
} from "./chunk-3CYHI6QV.mjs";
import {
  PaginatePipe,
  PaginationControlsComponent,
  SharedModule
} from "./chunk-YANBSHZU.mjs";
import {
  ApplicationRef,
...
var _SidebarComponent = class _SidebarComponent {
  constructor() {
    this.faUser = faUser;
    this.faGhost = faGhost;
    this.faMugHot = faMugHot;
...
_SidebarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 26, vars: 5, consts: [[1, "sidebar"], [1, "logo"], ["src", "assets/images/logo.png", "alt", "", 2, "width", "70px"], [1, "list-group", "list-group-flush"], [1, "list-group-item"], [1, "fa-lg", 3, "icon"], ["routerLink", "/home"], ["routerLink", "/product"]], template: function SidebarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(6, "a", 6)(7, "span");
    \u0275\u0275text(8, "Home");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "li", 4);
    \u0275\u0275element(10, "fa-icon", 5);
    \u0275\u0275elementStart(11, "a", 7)(12, "span");
    \u0275\u0275text(13, "Product");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "li", 4);
    \u0275\u0275element(15, "fa-icon", 5);
    \u0275\u0275elementStart(16, "span");
    \u0275\u0275text(17, "Contact");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "li", 4);
    \u0275\u0275element(19, "fa-icon", 5);
    \u0275\u0275elementStart(20, "span");
    \u0275\u0275text(21, "Bill");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "li", 4);
    \u0275\u0275element(23, "fa-icon", 5);
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275property("icon", ctx.faHouse);
    \u0275\u0275advance(5);
    \u0275\u0275property("icon", ctx.faMugHot);
    \u0275\u0275advance(5);
    \u0275\u0275property("icon", ctx.faSort);
    \u0275\u0275advance(4);
    \u0275\u0275property("icon", ctx.faUser);
    \u0275\u0275advance(4);
    \u0275\u0275property("icon", ctx.faGhost);
  }
}, dependencies: [FontAwesomeModule, FaIconComponent, RouterLink], styles: ["\n\nul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: black;\n  opacity: 0.9;\n}\n/*# sourceMappingURL=sidebar.component-YCOMVAKZ.css.map */"] });
...
_ProductitemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductitemComponent, selectors: [["app-productitem"]], inputs: { product: "product" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 22, vars: 10, consts: [[1, "cart", "row"], [1, "col-3"], ["width", "200", "src", "assets/images/img1.jpeg", "alt", ""], [1, "col-9", "d-flex", "flex-column", "justify-content-between", "cart-content"], [1, "d-flex", "align-items-start"], [1, "cart-title"], [1, "townhouse"], [1, "d-flex", "justify-content-between"], [1, "price"]], template: function ProductitemComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
    \u0275\u0275element(2, "img", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 3)(4, "div")(5, "div", 4)(6, "span", 5);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "uppercase");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14, "2 bedrooms \u2022 2 bathrooms \u2022 240m2");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(8, 3, ctx.product.name), " ");
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 5, ctx.product.price));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(21, 7, ctx.date, "dd-MM-Y"), " ");
  }
}, dependencies: [CommonModule, UpperCasePipe, CurrencyPipe, DatePipe] });
...
var _SearchComponent = class _SearchComponent {
  constructor() {
    this.searchParams = new EventEmitter();
    this.faMagnifyingGlass = faMagnifyingGlass;
    this.q = "";
  }
  handleSearch() {
...
_SearchComponent.\u0275fac = function SearchComponent_Factory(t) {
  return new (t || _SearchComponent)();
};
_SearchComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchComponent, selectors: [["app-search"]], outputs: { searchParams: "searchParams" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 2, consts: [[1, "input-group", "mb-3"], [1, "icon-search", 3, "icon"], ["type", "text", "placeholder", "Search", "aria-label", "Text input with checkbox", 1, "form-control", 3, "keyup.enter", "ngModelChange", "ngModel"]], template: function SearchComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275element(1, "fa-icon", 1);
    \u0275\u0275elementStart(2, "input", 2);
    \u0275\u0275listener("keyup.enter", function SearchComponent_Template_input_keyup_enter_2_listener() {
...
}, dependencies: [FontAwesomeModule, FaIconComponent, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel] });
...
function ContentComponent_app_productitem_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-productitem", 5);
    \u0275\u0275listener("click", function ContentComponent_app_productitem_10_Template_app_productitem_click_0_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.handleClickItem(item_r2));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r2 = ctx.$implicit;
    \u0275\u0275property("product", item_r2);
  }
}
var _ContentComponent = class _ContentComponent {
  constructor() {
    this.productItem = new EventEmitter();
    this.faFilter = faFilter;
    this.name = "Iphone 14";
    this.params = "";
    this.listProduct = [
...
_ContentComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContentComponent, selectors: [["app-content"]], outputs: { productItem: "productItem" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 3, consts: [[1, "content"], [3, "searchParams"], [1, "d-flex", "justify-content-between"], [3, "icon"], ["routerLink", "/product/detail", 3, "product", "click", 4, "ngFor", "ngForOf"], ["routerLink", "/product/detail", 3, "click", "product"]], template: function ContentComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "app-search", 1);
    \u0275\u0275listener("searchParams", function ContentComponent_Template_app_search_searchParams_1_listener($event) {
      return ctx.getParamsSearch($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 2)(3, "h5");
    \u0275\u0275text(4, "All Listings ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9, " Filter ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, ContentComponent_app_productitem_10_Template, 1, 1, "app-productitem", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1('Searching " ', ctx.params, '" ');
    \u0275\u0275advance(2);
    \u0275\u0275property("icon", ctx.faFilter);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx.listProduct);
  }
}, dependencies: [
  FontAwesomeModule,
  FaIconComponent,
  ...
  NgForOf,
  RouterLink
], styles: ["\n\n.empty[_ngcontent-%COMP%] {\n  opacity: 0.5;\n}\n/*# sourceMappingURL=content.component-VBJY5K63.css.map */"] });
var ContentComponent = _ContentComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContentComponent, { className: "ContentComponent" });
})();

// src/app/userinfo/userinfo.component.ts
var _UserinfoComponent = class _UserinfoComponent {
  constructor() {
    this.faChevronDown = faChevronDown;
    this.faBell = faBell;
  }
};
_UserinfoComponent.\u0275fac = function UserinfoComponent_Factory(t) {
  return new (t || _UserinfoComponent)();
};
_UserinfoComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserinfoComponent, selectors: [["app-userinfo"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 2, consts: [[1, "d-flex", "align-items-center", "justify-content-end", "user-info"], [1, "fa-xl", 3, "icon"], [1, "avatar"], ["src", "assets/images/img1.jpeg", "alt", "Avatar"], [3, "icon"]], template: function UserinfoComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "img", 3);
    \u0275\u0275text(5, " Pham Van Chien ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div");
    \u0275\u0275element(7, "fa-icon", 4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275property("icon", ctx.faBell);
    \u0275\u0275advance(5);
    \u0275\u0275property("icon", ctx.faChevronDown);
  }
}, dependencies: [FontAwesomeModule, FaIconComponent], styles: ["\n\n.user-info[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  margin-left: 10px;\n}\n/*# sourceMappingURL=userinfo.component-UZQJLWZ4.css.map */"] });
var UserinfoComponent = _UserinfoComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserinfoComponent, { className: "UserinfoComponent" });
})();

// src/app/productinfo/productinfo.component.ts
var _ProductinfoComponent = class _ProductinfoComponent {
  constructor() {
    this.count = 1;
  }
  ngDoCheck() {
...
_ProductinfoComponent.\u0275fac = function ProductinfoComponent_Factory(t) {
  return new (t || _ProductinfoComponent)();
};
_ProductinfoComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductinfoComponent, selectors: [["app-productinfo"]], standalone: true, features: [\u0275\u0275NgOnChangesFeature, \u0275\u0275StandaloneFeature], decls: 22, vars: 3, consts: [[1, "content-info"], ["src", "assets/images/img1.jpeg", "alt", "info"], [1, "townhouse"], [1, "price"], [1, "d-flex", "justify-content-end", "align-items-end"], [1, "btn", "btn-dark"], [1, "btn", "btn-dark", 3, "click"], ["type", "button", 1, "btn", "btn-dark", "btn-detail"]], template: function ProductinfoComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275element(1, "img", 1);
    \u0275\u0275elementStart(2, "h4");
    ...
    \u0275\u0275text(7, "2 bedrooms \u2022 2 bathrooms \u2022 240m2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 3);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p");
    \u0275\u0275text(11, " Follow the link below for a more detailed description. description of somebody/something a brief description of the software The name means \u2018no trees\u2019 and it is an accurate description of the island. Police have issued a description of the gunman. This is a film that defies description ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 4)(13, "div")(14, "button", 5);
    \u0275\u0275text(15, "-");
    \u0275\u0275elementEnd();
    \u0275\u0275text(16);
    \u0275\u0275elementStart(17, "button", 6);
    \u0275\u0275listener("click", function ProductinfoComponent_Template_button_click_17_listener() {
      return ctx.handleClickCount();
    });
    \u0275\u0275text(18, "+");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div")(20, "button", 7);
    \u0275\u0275text(21, "Add Cart");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate("Name");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(12324324353);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ctx.count, " ");
  }
} });
var ProductinfoComponent = _ProductinfoComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductinfoComponent, { className: "ProductinfoComponent" });
})();
...
_DetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DetailComponent, selectors: [["app-detail"]], inputs: { productInfo: "productInfo" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function DetailComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "aside");
    \u0275\u0275element(1, "app-productinfo");
    \u0275\u0275elementEnd();
  }
}, dependencies: [ProductinfoComponent] });
var DetailComponent = _DetailComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DetailComponent, { className: "DetailComponent" });
})();
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 0, consts: [[1, "d-flex"], [1, "col-2"], [1, "content"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "main", 0);
    \u0275\u0275element(1, "app-sidebar", 1);
    \u0275\u0275elementStart(2, "div", 2)(3, "header");
    \u0275\u0275element(4, "app-userinfo");
    \u0275\u0275elementEnd();
  ...
  CommonModule,
  UserinfoComponent
], styles: ["\n\n.content[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=app.component-RTQSX4D4.css.map */"] });
...
var _c02 = (a0) => ({ itemsPerPage: 2, currentPage: a0 });
...
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 6, consts: [[4, "ngFor", "ngForOf"], [3, "pageChange"]], template: function HomeComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "home works!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "ul");
    \u0275\u0275template(3, HomeComponent_li_3_Template, 2, 1, "li", 0);
    \u0275\u0275pipe(4, "paginate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "pagination-controls", 1);
    \u0275\u0275listener("pageChange", function HomeComponent_Template_pagination_controls_pageChange_5_listener($event) {
      return ctx.p = $event;
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind2(4, 1, ctx.collection, \u0275\u0275pureFunction1(4, _c02, ctx.p)));
  }
}, dependencies: [SharedModule, NgForOf, PaginationControlsComponent, PaginatePipe] });
...
_ProductComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductComponent, selectors: [["app-product"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 0, consts: [[1, "col-7"]], template: function ProductComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-content", 0);
  }
}, dependencies: [ContentComponent] });
var ProductComponent = _ProductComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductComponent, { className: "ProductComponent" });
})();
...
function RegisterComponent_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.err.error.message, "\n");
  }
}
var _RegisterComponent = class _RegisterComponent {
  constructor(authenService, route, toastr) {
    this.authenService = authenService;
    this.route = route;
    this.toastr = toastr;
  }
  handleSubmit(form) {
    this.authenService.register(form.value.email, form.value.password).subscribe((data) => {
      console.log(data);
...
_RegisterComponent.\u0275fac = function RegisterComponent_Factory(t) {
  return new (t || _RegisterComponent)(\u0275\u0275directiveInject(AuthenticationService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ToastrService));
};
_RegisterComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterComponent, selectors: [["app-register"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 1, consts: [["formLogin", "ngForm"], ["class", "alert alert-danger", "role", "alert", 4, "ngIf"], [3, "ngSubmit"], ["type", "email", "ngModel", "", "name", "email", 1, "form-control"], ["type", "password", "ngModel", "", "name", "password", 1, "form-control"], ["type", "submit", 1, "btn", "btn-info"], ["role", "alert", 1, "alert", "alert-danger"]], template: function RegisterComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "h1");
    \u0275\u0275text(1, "Form Register");
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, RegisterComponent_div_2_Template, 2, 1, "div", 1);
    \u0275\u0275elementStart(3, "form", 2, 0);
    \u0275\u0275listener("ngSubmit", function RegisterComponent_Template_form_ngSubmit_3_listener() {
      \u0275\u0275restoreView(_r1);
      const formLogin_r3 = \u0275\u0275reference(4);
      return \u0275\u0275resetView(ctx.handleSubmit(formLogin_r3));
    });
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.err);
  }
}, dependencies: [FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, CommonModule, NgIf, ToastrModule] });
...
var isAuthenticated = () => {
  const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Im9saXZpZXJAbWFpbC5jb20iLCJwYXNzd29yZCI6IjEyMzQ1NjMzY2MzMiIsImlhdCI6MTcxNzUyMDU2MywiZXhwIjoxNzE3NTIwNjYzfQ.kOO8f1DKMAFTeaoV5V9whQyR1NHg86PBj1oBNf7cn6g";
  const jwtHelper = new JwtHelperService();
  if (token === null)
    return false;
...
var routes = [
  { path: "register", component: RegisterComponent },
  {
    ...
    loadChildren: () => import("./chunk-42V6OBTO.mjs").then((m) => m.SharedModule)
  },
  {
    path: "product",
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4X7DYJTX.mjs.map
